...
void minDistanceBetweenRobots(vector<ERobot> vec, int numberOfRobots, int rob1, int rob2)
{
    ...
    cout << "ћинимальное рассто€ние между " << rob1 + 1 << " роботом и " << rob2 + 1 << " роботом  = " << temp_dis << endl;
    cout << "–обот " << rob1 + 1 << " находилс€ в координатах: x = " << nearest_x1 << " y = " << nearest_y1 << " и совершил в этот момент " << stepRob1 << " шагов" << endl;
    cout << "–обот " << rob2 + 1 << " находилс€ в координатах: x = " << nearest_x2 << " y = " << nearest_y2 << " и совершил в этот момент " << stepRob2 << " шагов" << endl;
}
...
int main()
{
    ...
    cout << "¬ведите количество роботов: ";
    cin >> numberOfRobots;
